...
# get a session!
session = InstaPy(username='cocogardenhh', password='password',headless_browser=True,want_check_browser=False,)
...
with smart_run(session):
    ...
    # activity
    session.interact_user_followers(['priyanath_goonetileke','dylan_dema'], amount=20)
